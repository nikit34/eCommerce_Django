...
class ProductQuerySet(models.query.QuerySet):
    ...
    def search(self, query):
        lookups = (Q(title__icontains=query) | Q(description__icontains=query) | Q(price__icontains=query) | Q(
...
class ProductFile(models.Model):
    ...
    file = models.FileField(upload_to=upload_product_file_loc,
                            storage=FileSystemStorage(location=settings.PROTECTED_ROOT), blank=True)
