    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.added) {
          if(lang == 'en') {
            submitSpan.html(
              "<div class='btn-group'> <a class='btn btn-success' href='/cart/'>In cart</a> <button type='submit' class='btn btn-outline-success'>Remove?</button></div>"
            );
            } else if(lang == 'ru'){
              submitSpan.html(
                "<div class='btn-group'> <a class='btn btn-success' href='/cart/'>Корзина</a> <button type='submit' class='btn btn-outline-success'>Удалить?</button></div>"
              );
          } else {
            submitSpan.html(
